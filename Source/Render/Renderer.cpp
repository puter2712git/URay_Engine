...
VkPipeline Renderer::CreateLinePipelineState()
{
    Shader* shader = shaderManager->GetOrCreate("line");

    auto vertShaderCode = shader->GetVertexStage().code;
    auto fragShaderCode = shader->GetFragmentStage().code;
